...
MONGODB_CONNECTION_STRING = os.getenv("MONGODB_CONNECTION_STRING") or os.getenv("DATABASE_PATH", "mongodb://localhost:27017/anuj_bot")
USE_MONGODB = bool(MONGODB_CONNECTION_STRING and MONGODB_CONNECTION_STRING.startswith("mongodb"))
